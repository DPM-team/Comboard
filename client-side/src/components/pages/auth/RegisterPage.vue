<template>
  <base-section>
    ...
    <auth-form @submit.prevent="submitForm">
      ...
      <p id="agreement">
        By clicking Agree & Join, you agree to the comboard <span class="span-link" @click="goToUAPage()">User Agreement</span> and
        <span class="span-link" @click="goToPPPage()">Privacy Policy.</span>
      </p>
    </auth-form>
    <p id="login-account">
      Already on Comboard?
...
export default {
  ...
  methods: {
    ...
    goToUAPage() {
      this.$router.push("/register/user-agreement");
    },
    goToPPPage() {
      this.$router.push("/register/privacy-policy");
    },
    getName(inputValue) {
