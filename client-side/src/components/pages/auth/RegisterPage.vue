      ...
      <base-dialog v-if="modalUA" :title="'User Agreement'" :overlay="true" @close="toggleUAModal">
        <template #main>
          <div class="pop-up">
            ...
            <h4>
              User data collected during the use of the Web App is stored in a MongoDB database. However, as of June 2023, no user data will be used under any circumstances, as this is a thesis
              project and not a real company application.
            </h4>
